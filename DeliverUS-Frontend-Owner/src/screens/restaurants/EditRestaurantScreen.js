...
export default function EditRestaurantScreen ({ navigation, route }) {
  ...
  // solucion
  const [initialRestaurantValues, setInitialRestaurantValues] = useState({ name: null, description: null, address: null, postalCode: null, url: null, shippingCosts: null, email: null, phone: null, message: null, restaurantCategoryId: null, logo: null, heroImage: null })
