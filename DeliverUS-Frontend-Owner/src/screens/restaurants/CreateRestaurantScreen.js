...
export default function CreateRestaurantScreen ({ navigation }) {
  ...
  //solucion
  const initialRestaurantValues = { name: null, description: null, address: null, postalCode: null, url: null, shippingCosts: null, email: null, phone: null, message:null,restaurantCategoryId: null }
